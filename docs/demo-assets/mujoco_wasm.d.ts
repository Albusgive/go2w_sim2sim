...
export interface RayCasterCamera extends ClassHandle {
  readonly width: number;
  readonly height: number;
  readonly validCount: number;
  readonly numThreads: number;
  changeData(_0: MjModel, _1: MjData): void;
  setNumThreads(_0: number): void;
  compute(_0: MjModel, _1: MjData): number;
  depthPointer(): number;
  hitPointPointer(): number;
  depthView(): any;
  hitPointView(): any;
}
...
interface EmbindModule {
  ...
  RayCasterCamera: {
    new(_0: MjModel, _1: MjData, _2: EmbindString, _3: number, _4: number, _5: number, _6: number, _7: number, _8: number, _9: number, _10: boolean, _11: number, _12: number, _13: number, _14: number): RayCasterCamera;
  };
