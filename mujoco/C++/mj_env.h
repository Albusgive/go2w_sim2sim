...
public:
  ...
  double cmd_pad_scale[3] = {1.0, 1.0, 2.0};
  void init_gamepad();
  ...
  std::vector<double> action_scale_vec = {0.125, 0.25, 0.25, 0.125, 0.25, 0.25,
                                          ...
                                          2.0,   2.0,  2.0,  2.0};
  std::vector<double> action2_scale_vec = {0.125, 0.25, 0.25, 0.125, 0.25, 0.25,
                                           0.125, 0.25, 0.25, 0.125, 0.25, 0.25,
                                           5.0,   5.0,  5.0,  5.0};
  ...
  unsigned char *ray_caster_camera_inv_img;
  unsigned char *ray_caster_camera_noise_inv_img;
  unsigned char *camera_img;
